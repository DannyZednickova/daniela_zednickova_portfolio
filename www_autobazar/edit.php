    ...
    <section class="box">
        <form action="<?= BASE_URL ?>/_admin/edit-car.php" method="post" id="form">
            ...
            <div class="row">
                ...
                <div class="col-75">
                    <select name="palivo" class="edit-selectors">
                        <option value=" "> Vyber</option>
                        <?php
                        echo make_options($array = ['benzin', 'nafta', 'LPG', 'ostatní'], $car->palivo ?? null) ?>
                    </select>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row bottom-buttons">
                ...
                <label for="dph"> MÁ / NEMÁ DPH <input type="checkbox" name="dph" value="1" <?= ($car->dph) === 1 ? 'checked' : '' ?> > </label>
                <label for="serviska"> MÁ / NEMÁ SERVISNÍ KNIHU <input type="checkbox" name="serviska" value="1" <?= ($car->serviska) === 1 ? 'checked' : '' ?> ></label>
